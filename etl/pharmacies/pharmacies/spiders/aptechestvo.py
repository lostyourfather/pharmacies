...
class FarmaniSpider(scrapy.Spider):
    ...
    def parse_page(self, response):
        for i in range(1, 20):
            ...
            object = AptechestvoItem(header=header, description=description, price=price, currency=currency, is_prescription=is_prescription, img_src=img_src, site_name='aptechestvo')
            yield object
